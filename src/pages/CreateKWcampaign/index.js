...
function CreateASINcampaign() {
    ...
    const tableData = [
        ['Adgroup', '001_SP_KW_SKU001_KW1_[tag]	', 'KW1', <Form.Control type="text" placeholder="Add tag" />, <Button onClick={handleExclude} type="submit">Exclude</Button>],
        ['Adgroup', '001a_SKU001_KW1_[tag]', 'KW1', '', <Button onClick={handleExclude} type="submit">Exclude</Button>],
        ['Adgroup', '001a_SKU001_KW1_[tag]', 'KW1', '', <Button onClick={handleExclude} type="submit">Exclude</Button>],
        ['Adgroup', '001a_SKU001_KW1_[tag]', 'KW1', '', <Button onClick={handleExclude} type="submit">Exclude</Button>],
        ['Adgroup', '001a_SKU001_KW1_[tag]', 'KW1', '', <Button onClick={handleExclude} type="submit">Exclude</Button>],
        ['Adgroup', '001a_SKU001_KW1_[tag]', 'KW1', '', <Button onClick={handleExclude} type="submit">Exclude</Button>],
    ...
    return (
        <>
            <Header />
            <div className="p-4">
                <h2 className='campaign-title'>Create SP KW campaign</h2>
            ...
            <CampaignModal campaign="KW" show={modalShow} onHide={() => setModalShow(false)} />
        </>
    );
}
